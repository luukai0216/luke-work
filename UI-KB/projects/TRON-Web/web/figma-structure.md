...
- 示例：`01 首页 — Default`、`02 钱包选择 — Hover`
...
与 `web/design.md` 中的 CSS Token 对应：

- 背景色：`Background/Black`、`Background/Deep`、`Background/Surface`
- 品牌色：`Brand/Red`、`Brand/Red Hover`
- 文字色：`Text/Primary`、`Text/Secondary`、`Text/Tertiary`
- 边框色：`Border/Default`、`Border/Light`
- 功能色：`Status/Success`、`Status/Warning`、`Status/Error`
